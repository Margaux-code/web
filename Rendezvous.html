    ...
    <div class="page" id="page">
        ...
        <div class="milieu" id="content">
            ...
            <div class="PresRDV">
                ...
                Vous avez un créneau libre, et vous voulez faire du sport ?</br>
                Choisissez votre date !
                </br>
                <form action="RDV_Tout_Coachs.php" method="post">
                    <input type="date" id="JRDV" name="JourChoisi" value="2022-06-02" min="2022-06-02" max="2022-06-10"
                        required>
                    <input type="submit" name="bouton" value="Trouver les rendez-vous disponible">
        ...
        <div class="footer" id="footer">
            <div class="copyright">068837068068837068
