...
<head>
    ...
    <link rel="stylesheet" media="screen and (max-width: 980px)" href="SportCompetition.css">
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <form action="presentation_coach.php" class="formCoach" method="post">
                            ...
                            <div class="caption">
                            <img src="Image/SalleDeSport/musculation.jpg"/>
                                <input type="submit" class="captionBtn" name="coach2" value=" COACH DE MUSCULATION">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <form action="presentation_coach.php" class="formCoach" method="post">
                            ...
                            <div class="caption">
                            <img src="Image/SalleDeSport/cardio_training.jpg"/>
                                <input type="submit" class="captionBtn" name="coach4" value=" COACH DE CARDIO-TRAINING">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <form action="presentation_coach.php" class="formCoach" method="post">
                            ...
                            <div class="caption">
                            <img src="Image/SalleDeSport/fitness.jpg"/>
                                <input type="submit" class="captionBtn" name="coach6" value=" COACH DE FITNESS">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="thumbnail">
                        <form action="presentation_coach.php" class="formCoach" method="post">
                            ...
                            <div class="caption"><!-- biking -->
                            <img src="Image/SalleDeSport/biking.jpg"/>
                                <input type="submit" class="captionBtn" name="coach7" value=" COACH DE BIKING">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <form action="presentation_coach.php" class="formCoach" method="post">
                            ...
                            <div class="caption">
                            <img src="Image/SalleDeSport/cours collectifs.jpg"/>
                                <input type="submit" class="captionBtn" name="coach10" value=" COACH DE COURS COLLECTIFS">
                            </div>
                        </form>
                    </div>
                </div>
